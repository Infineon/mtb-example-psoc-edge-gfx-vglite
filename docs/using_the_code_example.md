...
The following example clones the "[VGLITE](https://github.com/Infineon/mtb-example-psoc-edge-gfx-vglite)" application with the desired name "MyVgliteDemo" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-gfx-vglite --user-app-name MyVgliteDemo --target-dir "C:/mtb_projects"
   ```
